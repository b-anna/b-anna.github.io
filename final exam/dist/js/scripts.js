...
itemSelector:'.grid-item',columnWidth:200,gutter:2,isFitWidth:true

});});})();});"use strict";(function(){var grid=document.getElementById('grid');function SendGet(str){var strThis=str;var API_KEY='6079840-830cb613b58e5edfa3c59db4a';var URL="https://pixabay.com/api/?key="+API_KEY+"&q="+encodeURIComponent(strThis);var myData=fetch(URL).then(function(response){if(response.ok){return response.json();}throw new Error('ERROR fetching data!');}).then(function(data){if(data.hits.length>0){console.log(data.hits);for(var key in data.hits){var pShow=document.createElement('p');var img=document.createElement('img');var divWrapP=document.createElement('div');var divShow=document.createElement('div');var gridItem=document.createElement('a');pShow.setAttribute('class','pShow ');divWrapP.setAttribute('class','divWrapP ');divShow.setAttribute('class','divShow ');img.setAttribute('src',data.hits[key].previewURL);gridItem.setAttribute('class','grid-item ');gridItem.setAttribute('href',data.hits[key].webformatURL);pShow.innerHTML=data.hits[key].user;divWrapP.appendChild(pShow);divShow.appendChild(divWrapP);divShow.appendChild(img);gridItem.appendChild(divShow);grid.appendChild(gridItem);}return grid;}else{alert('объект не пришел');}}).catch(function(error){});}SendGet('n');var myInput=document.getElementById('textApi');var butSearch=document.getElementById('butSearch');butSearch.addEventListener('click',function(){//alert('Что то ...');
var myStr=myInput.value;// alert(myStr);
grid.innerHTML='';SendGet(myStr);myInput.value=" ";});myInput.addEventListener("keyup",function(event){event.preventDefault();if(event.keyCode==13){butSearch.click();}});})();"use strict";// document.addEventListener("DOMContentLoaded", function () {
(function(){var myDataL=[{id:1,src:"img/1.png",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:2,src:"img/forSlider_2.png",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:3,src:"img/forSlider_3.png",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."},{id:4,src:"img/2.jpg",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:5,src:"img/3.jpg",title:"Morbi velit risus",text:"The latest news, business, sport, comment, lifestyle and culture. Content from the Daily Telegraph and Sunday Telegraph newspapers "},{id:6,src:"img/4.jpg",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."}];var myDataM=[{id:1,src:"img/forSlider_1.png",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:2,src:"img/5.jpg",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:3,src:"img/forSlider_3.png",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."},{id:4,src:"img/6.jpg",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:5,src:"img/7.jpg",title:"Morbi velit risus",text:"The latest news, business, sport, comment, lifestyle and culture. Content from the Daily Telegraph and Sunday Telegraph newspapers "},{id:6,src:"img/8.jpg",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."}];var myDataR=[{id:1,src:"img/forSlider_1.png",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:2,src:"img/forSlider_2.png",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:3,src:"img/9.jpg",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."},{id:4,src:"img/10.jpg",title:"Morbi velit risus",text:"Nulla venenatis tempor dui in molestie. Nulla quis dictum purus, sit amet porttitor est."},{id:5,src:"img/11.jpg",title:"Morbi velit risus",text:"The latest news, business, sport, comment, lifestyle and culture. Content from the Daily Telegraph and Sunday Telegraph newspapers "},{id:6,src:"img/12.jpg",title:"Sed leo enim, condimentum",text:"Quisque libero libero, dictum non turpis in, luctus semper lorem. Donec rhoncus a leo sit amet facilisis."}];var htmlTableTemplateL=document.getElementById('slide-template-LL').innerHTML;var listLL=document.getElementById('listLL');var listL=_.template(htmlTableTemplateL);var listContentL=listL({'data':myDataL});listLL.innerHTML=listContentL;var htmlTableTemplateM=document.getElementById('slide-template-MM').innerHTML;var listMM=document.getElementById('listMM');var listM=_.template(htmlTableTemplateM);var listContentM=listM({'data':myDataM});listMM.innerHTML=listContentM;var htmlTableTemplateR=document.getElementById('slide-template-RR').innerHTML;var listRR=document.getElementById('listRR');var listR=_.template(htmlTableTemplateR);var listContentR=listR({'data':myDataR});listRR.innerHTML=listContentR;function SlidersGo(controlsd,slidesd,nextd,previousd){var next=nextd;var previous=previousd;var controls=controlsd;var slides=slidesd;var currentSlide=0;for(var i=0;i<controls.length;i++){controls[i].style.display='inline-block';}function nextSlide(){goToSlide(currentSlide+1);}function previousSlide(){goToSlide(currentSlide-1);}function goToSlide(n){slides[currentSlide].className='slide';currentSlide=(n+slides.length)%slides.length;slides[currentSlide].className='slide showing';}next.onclick=function(){nextSlide();};previous.onclick=function(){previousSlide();};}var controlsL=document.querySelectorAll('.controlsLL');var slidesL=document.querySelectorAll('.slideLL');var nextL=document.getElementById('nextLL');var previousL=document.getElementById('previousLL');var controlsM=document.querySelectorAll('.controlsMM');var slidesM=document.querySelectorAll('.slideMM');var nextM=document.getElementById('nextMM');var previousM=document.getElementById('previousMM');var controlsR=document.querySelectorAll('.controlsRR');var slidesR=document.querySelectorAll('.slideRR');var nextR=document.getElementById('nextRR');var previousR=document.getElementById('previousRR');SlidersGo(controlsL,slidesL,nextL,previousL);SlidersGo(controlsM,slidesM,nextM,previousM);SlidersGo(controlsR,slidesR,nextR,previousR);})();
